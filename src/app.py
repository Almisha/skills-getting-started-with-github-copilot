...
activities = {
    "Basketball": {
        ...
        "max_participants": 16,
        "participants": ["jane@mergington.edu"]
        },
        "Art Class": {
        ...
        "Drama Club": {
        "description": "Theater performances, script analysis, and acting workshops",
        ...
        "Science Club": {
        "description": "Explore STEM concepts through experiments and competitions",
